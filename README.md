...
| 仪表板 | 软件中心 |
|---|---|
| ![Dashboard](docs/dashboard/screen.png) | ![Software Center](docs/software_center/screen.png) |

| 环境管理 | 镜像设置 |
|---|---|
| ![Environment Manager](docs/environment_manager/screen.png) | ![Mirror Settings](docs/mirror_settings/screen.png) |
